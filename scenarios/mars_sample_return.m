...
%% With Drag
dt_drag = 6;
[t_traj_drag,capsule_traj_drag] = fast_drag_sim(t_lambert,capsule_pos_ti_j2000,capsule_vel_ti_j2000,mu_earth,capsule,ti_utc,space_weather_data,options);
